class ExperiencesController < ApplicationController
  ...
  def experience_params
    params[:experience][:company_id] = Company.all.find_or_create_by(name: params[:experience][:company_id]).id
    params[:experience][:city_id] = City.all.find_or_create_by(name: params[:experience][:city_id]).id
